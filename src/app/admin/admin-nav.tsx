...
import {
  LayoutDashboard, Building2, CreditCard, Scale, Landmark, Cpu, Handshake, Server, Globe, Bell, Ticket, BookOpen, ShieldCheck,
} from "lucide-react";
...
const NAV = [
  ...
  { href: "/admin/tim", label: "Admin Platform", icon: ShieldCheck },
