...
echo ""
echo "# iPaymu"
echo "PAYMENT_GATEWAY=ipaymu"
echo "IPAYMU_ENV=sandbox"
echo "IPAYMU_SANDBOX_VA=$(pick IPAYMU_SANDBOX_VA)"
echo "IPAYMU_SANDBOX_API_KEY=$(pick IPAYMU_SANDBOX_API_KEY)"
echo "IPAYMU_PRODUCTION_VA=$(pick IPAYMU_PRODUCTION_VA)"
echo "IPAYMU_PRODUCTION_API_KEY=$(pick IPAYMU_PRODUCTION_API_KEY)"
echo "IPAYMU_APP_URL=https://app.airconet.id"
echo ""
echo "# S3 BiznetGio"
