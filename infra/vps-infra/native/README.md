...
> Shared gateway production is maintained in `/home/rad/lumite-gateway`. This Aircon tree is only a historical integration reference.
...
- `aircon-gateway.service`, `aircon-bridge.service` — historical service templates.
